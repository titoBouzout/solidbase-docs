...
Solid 2.0 aligns better with web standards, making it easier to understand and explain. The main idea is that [MDN](https://developer.mozilla.org/) should suffice, and no Solid-specific rules are introduced.
